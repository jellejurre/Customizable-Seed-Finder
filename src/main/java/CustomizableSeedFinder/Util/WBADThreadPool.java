...
//Not gonna lie, this is yoinked straight from WearBlackAllDay because it's just a threadpool with an active count and I couldn't be arsed to write one myself.
public class WBADThreadPool {
    private ThreadPoolExecutor executor;
    private final int threadCount;
    private final IntLatch activeCount = new IntLatch();

    public WBADThreadPool() {
        this(Runtime.getRuntime().availableProcessors());
    }

    public WBADThreadPool(int threadCount) {
